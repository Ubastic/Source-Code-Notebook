...
parser.add_argument('--log_dir', type=str,default='./log',help='folder to save log')
parser.add_argument('--saved_model_folder',type=str,default='./weights', help='folder to save model')
parser.add_argument('--use_data_whitening', default=1, type=int, help='data whitening')
parser.add_argument('--use_laplacian_loss', default=1, type=int, help='laplacian loss')
parser.add_argument('--laplacian_loss_weight', default=0.05, type=float, help='laplacian loss weight')
parser.add_argument('--dataset_path', type=str,default='./ml-100k',help='dataset path')
parser.add_argument('--save_processed_data_path', type=str,default='./data',help='path to save the processed data')
