...
import sys
sys.path.append('D:/DeepLearning/GCN/gcn-pytorch/pygcn')
...
# print('adj的维度:',adj.shape)              # 2708*2708邻接矩阵
# print('features的维度:',features.shape)    # 2708*1433 2708个点的关键词特征向量
# print('labels的维度:',labels.shape)        # 2708*1 论文分类标签 一共7个类别
